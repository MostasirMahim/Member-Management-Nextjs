...
interface InvoicePaymentOptionsResponse {
  code: number;
  message: string;
  status: string;
  data: InvoicePaymentOption[];
}

interface Props {
  invoice_payment_options: InvoicePaymentOptionsResponse;
}

export default function InvoicePaymentOptionsTable({ invoice_payment_options }: Props) {
