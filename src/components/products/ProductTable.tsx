          ...
          <Table className="text-sm">
            <TableHeader>
              <TableRow className="bg-muted/50 hover:bg-muted/50">
                <TableHead className="text-foreground font-bold text-base py-4">
                  Image
                </TableHead>
                <TableHead className="text-foreground font-bold text-base py-4">
                  Name
                ...
                <TableHead className="text-foreground font-bold text-base py-4 text-right">
                  Actions
                </TableHead>
              </TableRow>
            </TableHeader>
                ...
                >
                  <TableCell>
                    <Image
                      src={
                        prod.media[0]?.image
                          ? `${process.env.NEXT_PUBLIC_BACKEND_API_URL}${prod.media[0]?.image}`
                          : "/placeholder.png"
                      }
                      alt={prod.name}
                      width={56}
