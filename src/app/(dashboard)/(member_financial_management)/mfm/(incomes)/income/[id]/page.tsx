...
import { IncomeReceipt } from "@/components/member_financial_management/Income/IncomeDetails";

export default async function SingleIncomePage({
  params,
}: {
  params: { id: string };
}) {
