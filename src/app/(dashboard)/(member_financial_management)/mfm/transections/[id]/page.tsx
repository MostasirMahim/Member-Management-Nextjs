...
import TransactionDetails from "@/components/member_financial_management/Transections/TransactionDetails";

export default async function SingleTransactionPage({ params }: { params: { id: string } }) {
